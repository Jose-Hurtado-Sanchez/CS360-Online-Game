...
int main()
{
    ...
    server = enet_host_create(&address,2,1,20,20); // 2 client can connect, 2 channels one reliable and one unreliable 0 for both bandwith limiatation cause we watn to go as fast as possible
